        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            <h1 className="text-5xl md:text-7xl font-black leading-10 mb-4" data-aos="zoom-y-out">
              🎉{" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#1939FF] to-[#00B1FF]">
                Wonders
              </span>{" "}
              are made by{" "}
              <span className="bg-bottom bg-[length:100%_4px] bg-no-repeat bg-gradient-to-r from-[#1939FF] to-[#00B1FF] italic tracking-wide">
                {" "}
                collaboration
              </span>
              .
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-600 my-8" data-aos="zoom-y-out" data-aos-delay="150">
                The place where you can find the most innovative ideas, potential projects, or dedicated mentors.
              </p>
              <div
