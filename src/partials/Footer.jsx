    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
            <div className="mb-2">
              ...
              <Link to="/" className="inline-block" aria-label="Cruip">
                <img className="h-fit w-6" src="logo.png" alt="BindUP logo" />
              </Link>
            </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">Made by <span className="text-blue-600 hover:underline">DolphinGroup</span>. All rights reserved.</div>
