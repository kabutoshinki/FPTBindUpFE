...
export const Newsletter = () => {
  return (
    <div className="mb-6">
      <div className="mt-4 text-base font-bold mb-3 text-gray-900">Newsletter</div>
      <div className="bg-white rounded shadow ">
        <div>
          <div className="border-b border-gray-200">
            <img src={Advertisment} alt="advertisment newletter" />
            <div className="text-xl text-gray-900 text-center pt-4 pb-4">Star in a Super Bowl ad 🏈</div>
          </div>
          <div className="p-5">
