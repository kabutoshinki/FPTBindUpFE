        ...
        <div className="flex justify-between items-center">
          ...
          >
            <svg className="w-7 h-7 mr-[10px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3 6C3 4.34315 4.34315 3 6 3H14C15.6569 3 17 4.34315 17 6V14C17 15.6569 15.6569 17 14 17H6C4.34315 17 3 15.6569 3 14V6Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M21 7V18C21 19.6569 19.6569 21 18 21H7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M10 10V7M10 10V13M10 10H13M10 10H7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            <p>
              Post a job
            </p>
                      ...
                      <div className="flex justify-between items-center h-[110px] border-[1px] border-slate-200 rounded px-[20px] py-[15px] mb-[20px] relative hover:bg-gradient-to-bl hover:from-[#e6f7ff] hover:via-white hover:to-white">
                        ...
                        <div className="p-0 m-0 h-full flex flex-col items-end justify-between">
                          <div className="mb-[20px]">
                            <span class="bg-indigo-50 text-indigo-700 text-xs font-medium mr-2 px-2.5 py-0.5 rounded ">#engineer</span>
                            <span class="bg-indigo-50 text-indigo-700 text-xs font-medium px-2.5 py-0.5 rounded ">#data</span>
                          </div>
                          <button className=" bg-white w-[70px] border border-slate-200 group hover:border-blue-600 rounded">
                            <div className="px-[10px] py-[10px] text-slate-500 group-hover:text-blue-600">
                              <span className="text-[0.8rem] font-semibold block text-center">
                                Apply
                              </span>
                            </div>
                          </button>
