    ...
    return (
        <div>
            <div className="flex items-center mb-3">
                ...
                <p className="ml-2 text-sm font-medium text-gray-900">4.95 out of 5</p>
            </div>
            ...
            <div className="flex items-center mt-4">
                ...
                <div className="w-[40%] h-3.5 mx-4 bg-gray-200 rounded ">
                    <div className="h-3.5 bg-blue-400 rounded w-[70%]"></div>
                </div>
            ...
            <div className="flex items-center mt-4">
                ...
                <div className="w-[40%] h-3.5 mx-4 bg-gray-200 rounded ">
                    <div className="h-3.5 bg-blue-400 rounded w-[17%]"></div>
                </div>
            ...
            <div className="flex items-center mt-4">
                ...
                <div className="w-[40%] h-3.5 mx-4 bg-gray-200 rounded ">
                    <div className="h-3.5 bg-blue-400 rounded w-[8%]"></div>
                </div>
            ...
            <div className="flex items-center mt-4">
                ...
                <div className="w-[40%] h-3.5 mx-4 bg-gray-200 rounded ">
                    <div className="h-3.5 bg-blue-400 rounded w-[4%]"></div>
                </div>
            ...
            <div className="flex items-center mt-4">
                ...
                <div className="w-[40%] h-3.5 mx-4 bg-gray-200 rounded ">
                    <div className="h-3.5 bg-blue-400 rounded w-[1%]"></div>
                </div>
