...
const ProjectList = ({ selectedMilestones }) => {
  ...
  const { data, loading, reFetch } = useFetch(
    `http://fhunt-env.eba-pr2amuxm.ap-southeast-1.elasticbeanstalk.com/api/v1/project/?pageNo=${currentPage}&pageSize=5&sortBy=created_date&statusType=0&ascending=ASC${nameKeyword()}${milestone()}`
  );
